...
> 사실 JPA보다 [ORM](https://github.com/daadaadaah/my-jpa/blob/main/ORM.md)을 이해하는게 중요하다. ORM 기술은 java 진영에서도 쓰이고, JS/TS 진영에서도 쓰이므로, ORM 기술을 잘 알면, 다른 언어더라도 ORM 프레임워크를 이해하는데 도움이 된다고 생각한다.
